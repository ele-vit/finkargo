...
def test_delete_user(client):
    ...
    assert result['message'] == 'Deleted user successfully'


def test_delete_user_not_exist(client):
    response = client.delete("/user/99999999", headers=headers,
                             content_type="application/json")
...
def test_delete_user_id_not_valid(client):
    response = client.delete("/user/xxxxxxx", headers=headers,
                             content_type="application/json")
